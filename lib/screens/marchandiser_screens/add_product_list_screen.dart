...
class _AlternativeUnitsBottomSheet extends StatelessWidget {
  ...
  const _AlternativeUnitsBottomSheet(
      {required this.data, required this.onItemSelected});
...
//             try {
//               return _categories
//                   .firstWhere((category) => category.grpName == categoryName)
//                   .grpId;
//             } catch (e) {
...
//           .where((id) => id != -1)
//           .toList();
//       log("Selected Categories: $_selectedCategories");
//       log("Selected Category IDs: $_selectedCategoryIds");
//     });
//   }

//   // Apply filters based on search and selected categories
//   void _applyFilters() async {
//     log("Applying filters: ${_searchController.text}");
//     try {
//       final result = await _apiService.getProductAndCategories(
//         flag: 101,
//         pageNo: 1,
...
//     return WillPopScope(
//       onWillPop: () async => Future.value(_willpop.onWillPop()),
//       child: Scaffold(
//         resizeToAvoidBottomInset: false,
//         appBar: _buildAppBar(context, cartProvider),
//         body: Container(
...
//     List<Category> sortedCategories = List.from(_filteredCategories)
//       ..sort((a, b) {
//         if (_localSelectedCategories.contains(a.grpName) &&
//             !_localSelectedCategories.contains(b.grpName)) {
//           return -1;
//         } else if (!_localSelectedCategories.contains(a.grpName) &&
//             _localSelectedCategories.contains(b.grpName)) {
//           return 1;
//         } else {
//           return a.grpName.compareTo(b.grpName);
